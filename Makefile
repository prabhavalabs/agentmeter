...
.PHONY: setup lint test host-test desktop-test desktop-build desktop-project desktop-widget-script-test desktop-widget-build desktop-widget-verify desktop-app desktop-community-dmg firmware-test firmware clean
...
desktop-widget-script-test:
	desktop/scripts/test-verify-widget-bundle.sh
